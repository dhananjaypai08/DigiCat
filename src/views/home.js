  ...
  return (
        ...
        <div data-thq="thq-mobile-menu" className="home-mobile-menu">
          ...
          >
            <div className="home-container1">
              <span className="home-logo1">DigiCat</span>
    ...
    {verified !==undefined && <ul className="home-cards">
      ...
      <div className="home-card">
          <li className="home-paragraph">The Product with Hash: {verifiedURI} is <h3>verified</h3>
      ...
      <div className="home-card" style={{width: 700}}>
          <li className="home-paragraph">The Product with Hash: {verifiedURI} is <h3>NOT Verified</h3>
          </li>
      </div>
      }
      </ul>}
      
      {isConnected && <><label className='mint-btn'>Total DigitCat's Minting Volume: {totalmints}
      </label> <label className='mint-btn'>Total DigiCat's Shared Volume: {total_endorsements}</label><br></br></>}
      {isConnected && admin && <Loginsystem></Loginsystem>}
      <section className="home-hero">
      
      {!isConnected && <div className="home-heading">
          <h1 className="home-header">DigiCat: Secure & decentralized product catalogs with Soulbound NFTs for retail.</h1>
          <p className="home-caption">
          Decentralized Identity Verification and storage system for all your SKU's.
          </p>
        </div>}
      ...
      <p className="caption">
          Your DigiCat Profile:
      </p>
      <label className='home-button7 button'>Total DigiCat Sharings allowed: {endorsementsAllowed}</label>
        <label className='home-button7 button'>DigiCat SBT's minted to your account
        </label>
        <ul>{fetched_nftdata && 
    ...
    {isConnected && <div className="home-container">
      <label className='home-button7 button'>DigiCat SBT's shared to your account
      </label>
        <ul>{fetched_nftdata && 
            ...
            <div className="home-main">
              <div className="home-content01">
                <h2 className="home-header01">
                  70% of the Products are web2 based or paper based
                </h2>
            ...
            <div className="home-main1">
              <div className="home-content02">
                <h2 className="home-header02">
                  DigiCat: Decentralized Identity verification and storage system
                </h2>
